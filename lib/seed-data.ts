  ...
  users: [
    {
      id: "manager",
      name: "Selina",
      email: "manager@utilitybelt.local",
    ...
    },
    {
      id: "jesse",
      name: "Jesse",
      email: "jesse@utilitybelt.local",
      passcode: "jesse-pace",
      systemRole: "member",
      roleLabel: "Execution Operator",
      teamId: "execution-team",
      active: true,
    },
    {
      id: "jose",
      name: "Jose",
      email: "jose@utilitybelt.local",
      passcode: "jose-pace",
      systemRole: "member",
      roleLabel: "Growth Support",
      teamId: "execution-team",
      active: true,
    },
  ],
  ...
  boards: [
    {
      ...
      tasks: [
        ...
        {
          id: "jesse-4",
          title: "Close out 6 reporting notes",
          type: "admin",
          status: "todo",
        ...
        {
          id: "jesse-5",
          title: "Push 5 schema fixes to queue",
          type: "build",
          status: "todo",
    ...
    },
    {
      ...
      tasks: [
        ...
        {
          id: "jose-3",
          title: "Review 8 citation issues",
          type: "build",
          status: "done",
          createdAt: "2026-04-02T08:30:00.000Z",
        },
